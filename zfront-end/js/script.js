...
let ser = document.querySelector("header .container .icons .ser");
...
ser.onclick = function () {
  if (!(this.getAttribute("animated") == "true")) {
    ...
    this.style.animation = "circle ease-in-out .5s forwards";
    inpSer.style.animation = "g-of-input .5s ease-in-out .5s forwards";
    this.setAttribute("animated", true);
  } else {
    this.style.animation = "not-circle .5s ease-in-out forwards";
...
let topSec = [
  {
    categorys: "sports",
    secImg: "img/gallery/sports.jpeg",
    label: "sports wear",
  },

  {
    categorys: "men",
    secImg: "img/gallery/team-1.jpeg",
    label: "parnds",
  },

  {
    categorys: "women",
    secImg: "img/gallery/cat-2.jpg",
    label: "fashons",
  },

  {
    categorys: "kids",
    secImg: "img/gallery/cat-3.jpg",
    label: "cutenes",
  },
];
